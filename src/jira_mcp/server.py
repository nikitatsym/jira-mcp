"""Jira MCP server — auto-discovery, Pydantic validation, schema introspection, dispatch."""
...
def _build_params_model(fn) -> type[BaseModel]:
    ...
    @field_validator("*", mode="before")  # type: ignore[misc]  # Pydantic 2 needs both field_validator and classmethod here
    @classmethod
...
def _build_help(group_name: str, search: str | None = None) -> str:
    ...
    if search:
        ...
        def _hit(name: str, fn) -> bool:
            ...
            # "gate") find ops named differently.
            return (
                s in name.lower()
